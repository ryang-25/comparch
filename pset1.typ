...
power while in this“barely alive” state.
  ...
  +  How much power savings would be achieved by reducing the volt- age by 20% and
   frequency by 40%?
...
servers, followed closely by scalability and throughput.
  ...
  + Imagine that the government, to cut costs, is going to build a super-
    computer out of inexpensive computers rather than expensive, reliable
